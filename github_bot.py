...
def send_startup_message():
    ...
    try:
        message = "✅ Year Progress Bot is now online!\n\nI'll send daily updates at 5:00 AM."
        import requests
        url = f"https://api.telegram.org/bot{BOT_TOKEN}/sendMessage"
        payload = {
            "chat_id": CHANNEL_ID,
...
def main():
    """Main function to run the bot for GitHub Actions"""
    logger.info("Year Progress Bot started for GitHub Actions")
    logger.info("Running for 5 minutes then exiting...")
    ...
    logger.info("Stopping bot after 5 minutes (GitHub Actions limit)")
